...
define('SITE_URL', 'http://127.0.0.1/MHHotelBooking/');
...
define('UPLOAD_IMAGE_PATH', $_SERVER['DOCUMENT_ROOT'].'/MHHotelBooking/images/');
...
function uploadImage($image,$folder) //same uploadUserImage
{
    try {
        ...
        if(!in_array($img_mime,$valid_mime)){
            ...
            $moved = move_uploaded_file($image['tmp_name'],$img_path);
            var_dump($image);
            ...
            // }
            // else{
            //     return 'upd_failed'; //upload error
            // }
        }
    } catch (\Throwable $th) {
        //throw $th;
