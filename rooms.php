...
<html lang="en">
              ...
              <div class="border bg-light p-3 rounded mb-3">
                ...
                <div class="d-flex">
                  ...
                  <div>
                    ...
                    <input type="number" min="1" id="children" value="<?php echo $adult_default ?>" oninput="guests_filter()" class="form-control shadow-none">
                  </div>
                </div>
              </div>
            </div>
  ...
  <script>
    ...
    {
      let chk_avail = JSON.stringify({  // chuyển đối tượng JavaScript thành một chuỗi JSON
